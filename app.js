...
app.put('/players/:playerId/', async (request, response) => {
  ...
  const getSqlQuery = `update player_details set player_name='${playerName}';`
...
app.get('/matches/:matchId/players', async (request, response) => {
  const {matchId} = request.params
  const getSqlQuery = `select player_details.player_id as playerId, player_details.player_name  as playerName from player_match_score natural join player_details on player_match_score.player_id=player_details.player_id where match_id=${matchId};`
